...
class CHMM_LCM(object):
    def __init__(self, x, a, container, n_clones=1, pseudocount=0.0, dtype=np.float32, seed=42, filename='best_model.pkl'):
...
def forward(T_tr, Pi, n_clones, x, a, container,store_messages=False):
  # JY changed for full bottom-up assignment of clones (i.e., no prior assumption about the number of observations)
    ...
    assignment, _ =  CRP(container, ind, alpha=100)
